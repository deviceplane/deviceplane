...
push-controller-latest: push-controller
	docker tag deviceplane/controller:${CONTROLLER_VERSION} deviceplane/controller:latest
	docker push deviceplane/controller:latest
...
push-controller-with-db-latest: push-controller-with-db
	docker tag deviceplane/deviceplane:${CONTROLLER_VERSION} deviceplane/deviceplane:latest
