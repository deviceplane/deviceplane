...
type DeviceApplicationStatuses interface {
	...
	ListAllDeviceApplicationStatuses(ctx context.Context, projectID string) (map[string]map[string]models.DeviceApplicationStatus, error)
...
type DeviceServiceStates interface {
	...
	ListAllDeviceServiceStates(ctx context.Context, projectID string) (map[string]map[string]map[string]models.DeviceServiceState, error)
