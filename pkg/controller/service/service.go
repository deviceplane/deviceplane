...
func NewService(
	...
	apiRouter.HandleFunc("/projects/{project}/devices/{device}/connecttcp/{connection}", s.connectTCP)
	apiRouter.HandleFunc("/projects/{project}/devices/{device}/connecthttp/{connection}", s.connectHTTP)
