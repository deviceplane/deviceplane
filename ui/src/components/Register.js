...
import { toaster, Pane, majorScale, minorScale, Heading, Alert,
  TextInputField, Button, Text, Link, Icon  } from 'evergreen-ui';
    ...
    return (
      ...
      >
        ...
        <Pane is="form">
          ...
          />
          <Text color="muted" size={300} marginBottom={minorScale(1)}>Password must be:</Text>
          <Pane
            display="flex"
            alignItems="center"
            marginBottom={minorScale(1)}
          >
            {this.state.passwordCharacterCheck ? <Icon icon="tick-circle" color="success" marginRight={majorScale(1)} />
              : <Icon icon="ban-circle" color="danger" marginRight={majorScale(1)} />
            }
            <Text color="muted" size={300}>Minimum of 8 characters</Text>
          </Pane>
          <Pane
            display="flex"
            alignItems="center"
            marginBottom={minorScale(1)}
          >
            {this.state.passwordLowercaseCheck ? <Icon icon="tick-circle" color="success" marginRight={majorScale(1)} />
              : <Icon icon="ban-circle" color="danger" marginRight={majorScale(1)} />
            }
            <Text color="muted" size={300}>Contains at least one lower case letter</Text>
          </Pane>
          <Pane
            display="flex"
            alignItems="center"
            marginBottom={minorScale(1)}
          >
            {this.state.passwordUppercaseCheck ? <Icon icon="tick-circle" color="success" marginRight={majorScale(1)} />
              : <Icon icon="ban-circle" color="danger" marginRight={majorScale(1)} />
            }
            <Text color="muted" size={300}>Contains at least one upper case letter</Text>
          </Pane>
          <Pane
            display="flex"
            alignItems="center"
          ...
          >
            {this.state.passwordNoSpacesCheck ? <Icon icon="tick-circle" color="success" marginRight={majorScale(1)} />
              : <Icon icon="ban-circle" color="danger" marginRight={majorScale(1)} />
            }
            <Text color="muted" size={300}>Contains no spaces</Text>
          </Pane>
          <TextInputField
            type="password"
